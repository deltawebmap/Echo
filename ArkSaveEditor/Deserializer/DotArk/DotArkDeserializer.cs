...
{
    public delegate StreamableGameobjectAccept StreamableGameobjectLoad(DotArkGameObject obj, object data);
    public delegate void StreamableGameobjectAccept(DotArkGameObject obj, List<DotArkProperty> props, object data);
    ...
    public class DotArkDeserializer
    {
        ...
        public DotArkFile OpenArkFile(MemoryStream mms, StreamableGameobjectLoad callback, object data)
        {
            //Convert this to our IO Memory Stream
            ms = new IOMemoryStream(mms, true);
            return OpenArkFile(ms, callback, data);
        }

        public DotArkFile OpenArkFile(IOMemoryStream ms, StreamableGameobjectLoad callback, object data)
        {
            this.ms = ms;
            ...
            ReadPropertiesForGameObjects(callback, data);
        ...
        void ReadPropertiesForGameObjects(StreamableGameobjectLoad callback, object data)
        {
            //Loop through each GameObject and read their information.
            foreach (var g in gameObjects)
                g.ReadPropsFromFile(this, callback, data);
        }

...
namespace ArkSaveEditor.Entities.LowLevel.DotArk
{
    public class DotArkGameObject
    {
        ...
        public List<DotArkProperty> ReadPropsFromFile(DotArkDeserializer ds)
        {
            ...
            List<DotArkProperty> props = new List<DotArkProperty>();
            while (prop != null)
            {
        ...
        public void ReadPropsFromFile(DotArkDeserializer ds, StreamableGameobjectLoad callback, object data)
        {
            StreamableGameobjectAccept next = callback(this, data);
            if (next != null)
                next(this, ReadPropsFromFile(ds), data);
        }
    }
}
